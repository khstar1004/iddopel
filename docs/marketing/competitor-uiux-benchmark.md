...
| WhatsMyName.io | Public username search is framed as research leads, not identity proof. | Keep the same safety boundary everywhere: 공개 계정 후보, not 동일인 계정. |
...
- The primary CTA is `공개 후보 확인`, not a score-focused CTA.

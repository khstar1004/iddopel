...
TOSS_RELEASE_CHECK=true SITE_URL="https://YOUR_CLOUDTYPE_OR_CUSTOM_DOMAIN" PAYMENT_PROVIDER=toss npm run toss:verify
...
- 무료 플랜에서는 Maigret의 동시 스캔을 크게 늘리지 않습니다. 초기값은 `MAIGRET_TOP_SITES_QUICK=100`, `MAIGRET_TOP_SITES_DEEP=500`, 앱 replica 1개로 시작합니다.

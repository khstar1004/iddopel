...
## Objective
사용자가 아이디 문자열을 입력하면 공개 username 사용 흔적을 점수화해 보여주는 한국어 웹/PWA MVP를 만든다. 이 MVP는 바이럴 랜딩, 안전한 목적 확인, 빠른 스캔, 무료 요약, 일부 결과 미리보기, 검색 기록 삭제, 기본 조치 가이드, 토스 인앱용 순한맛 화면, 출시 제출 문서를 포함한다.

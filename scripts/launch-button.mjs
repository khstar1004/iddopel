...
const sensitiveKeyPattern =
  /(SECRET|PASSWORD|PRIVATE_KEY|SERVICE_ACCOUNT|DATABASE_URL|WEBHOOK_URL|TOKEN|KEYSTORE|KEY_ID|ISSUER_ID|API_KEY|CLIENT_KEY|SECURITY_KEY)/i;
...
export function buildLaunchEnvironment({ fileEnv = {}, env = {} } = {}) {
  ...
  merged.MAIGRET_CRITICAL_SITES ||= "Twitter,Instagram,Threads";
  merged.MAIGRET_CRITICAL_RESCAN ||= "adaptive";
  merged.MAIGRET_CRITICAL_SITE_TIMEOUT_SECONDS ||= "22";
  merged.MAIGRET_CRITICAL_MAX_CONNECTIONS ||= "3";
  merged.MAIGRET_CRITICAL_RETRIES ||= "2";
  ...
  merged.SCAN_RESULT_METADATA_ENABLED ||= "true";
  merged.SCAN_RESULT_METADATA_LIMIT ||= "3";
  merged.SCAN_RESULT_METADATA_TIMEOUT_MS ||= "1200";
  merged.SCAN_RESULT_METADATA_MAX_BYTES ||= "65536";
